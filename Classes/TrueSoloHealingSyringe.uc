class TrueSoloHealingSyringe extends TrueSoloHealingBase; 

// I'm pretty sure this entire file is identical to the KFWeap_Healer_Syringe file located in C:\Program Files (x86)\Steam\steamapps\common\killingfloor2\Development\Src\KFGameContent\Classes. The purpose of this file is 
// to create a syringe that uses "TrueSoloHealingBase" as its base behavior rather than KFWeap_HealerBase located in C:\Program Files (x86)\Steam\steamapps\common\killingfloor2\Development\Src\KFGame\Classes.
