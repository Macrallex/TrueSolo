			...
			// IV - BY DIFFICULTY
				...
				// V - HEALING FOR YOURSELF AND OTHERS
					...
					// VI - HELL ON EARTH SYRINGE
						...
						SyringeHealAmountHel = SyringeHealAmountUni;    				// Hell on Earth base healing amount
						SyringeOthersHealAmountHel = SyringeOthersHealAmountUni;		// Hell on Earth base healing amount when healing others
						
						
					// VI - SUICIDAL SYRINGE
					
						SyringeHealAmountSui = SyringeHealAmountUni;    				// Hell on Earth base healing amount
						SyringeOthersHealAmountSui = SyringeOthersHealAmountUni;		// Hell on Earth base healing amount when healing others
						
						
					// VI - HARD SYRINGE
					
						SyringeHealAmountHar = SyringeHealAmountUni;  					// Hell on Earth base healing amount
						SyringeOthersHealAmountHar = SyringeOthersHealAmountUni;		// Hell on Earth base healing amount when healing others
						
						
					// VI - NORMAL SYRINGE
					
						SyringeHealAmountNor = SyringeHealAmountUni;    				// Hell on Earth base healing amount
						SyringeOthersHealAmountNor = SyringeOthersHealAmountUni;		// Hell on Earth base healing amount when healing others
				...
				// V - RECHARGE AFTER HEALING YOURSELF AND OTHERS
					...
					// VI - HELL ON EARTH SYRINGE
						...
						SyringeRechargeHel = SyringeHealAmountUni;     				// Hell on Earth base healing amount
						SyringeOthersRechargeHel = SyringeOthersHealAmountUni;		// Hell on Earth base healing amount when healing others
						
					// VI - SUICIDAL SYRINGE
					
						SyringeRechargeSui = SyringeHealAmountUni;    				// Hell on Earth base healing amount
						SyringeOthersRechargeSui = SyringeOthersHealAmountUni;		// Hell on Earth base healing amount when healing others
						
					// VI - HARD SYRINGE
					
						SyringeRechargeHar = SyringeHealAmountUni;   				// Hell on Earth base healing amount
						SyringeOthersRechargeHar = SyringeOthersHealAmountUni;		// Hell on Earth base healing amount when healing others
						
					// VI - NORMAL SYRINGE
					
						SyringeRechargeNor = SyringeHealAmountUni;     				// Hell on Earth base healing amount
						SyringeOthersRechargeNor = SyringeOthersHealAmountUni;		// Hell on Earth base healing amount when healing others
			}
