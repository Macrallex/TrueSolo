...
// I - SYRINGE VARIABLES
	...
	// II - Healing reacharge time for yourself and after healing others
		...
		var config float TrueSoloHealOthersRechargeSeconds;														// Creates a new configurable variable for the syringe base recharge time after healing others in KFTrueSolo.ini
...
simulated function CustomFire() // Redeclared parent function to replace variables
{
	...
	if( Role == ROLE_Authority )
	{
		...
		if( CurrentFireMode == DEFAULT_FIREMODE )
		{
			...
			HealRechargeTime = TrueSoloHealOthersRechargeSeconds;
		}
		// Healing Self
